...
In order to create Property Definitions you need to create an APS app that will provide the credentials we need to use: https://aps.autodesk.com/en/docs/oauth/v2/tutorials/create-app/ 
